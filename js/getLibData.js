function loadLibData(globalData) {
    return {
        getIndexByName: function (inputData, name) {
            var index;
        ...
        sortArrayByName: function (inputData) {
            return inputData.sort(function (a, b) {
                return d3.ascending(a.name, b.name)
            })
        },

        sortArrayByValue: function (inputData, property) {
            return inputData.sort(function (a, b) {
                return b[property] - a[property];
            })
        },

        sortArrayBySimilarity: function (source, target, inputData) {
        ...
        sortArrayByLinkSize: function (inputData) {
            return inputData.sort(function (a, b) {
                return b.links.length - a.links.length;
            })
        },

        sortArrayByCountSize: function (inputData) {
            return inputData.sort(function (a, b) {
        ...
        create2DMatrix: function (rows, cols, links) {
        ...
        drawMatrix: function (rowLabel, colLabel, inputData, position) {
        ...
        createNodesFromLinks: function (links) {
        ...
        loadMatrix: function (input_links) {
